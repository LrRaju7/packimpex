...
const Breadcrumb = ({id}) => {
  ...
  return (
    <>
      {loading ? null : (
        <>
          <li class="breadcrumb-item"><a href={pageBreadcrumb.field_breadcrumb_url != null ? pageBreadcrumb.field_breadcrumb_url : null}>{pageBreadcrumb.field_breadcrumb_name}</a></li>            
        </>
      )}
    </>
  )
